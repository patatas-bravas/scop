...
pub fn deleteVAO(vao: c_uint) void {
    gl.DeleteVertexArrays(1, @ptrCast(&vao));
}

pub fn createVBO(vertices: []const f32) c_uint {
...
pub fn deleteVBO(vbo: c_uint) void {
    gl.DeleteBuffers(1, @ptrCast(&vbo));
}

pub fn createEBO(indices: []const u32) c_uint {
...
pub fn deleteEBO(ebo: c_uint) void {
